...
def start_server(port_override: int | None = None, host_override: str | None = None) -> None:
    settings = read_trading_settings()
    host = host_override if host_override is not None else settings["server"]["host"]
